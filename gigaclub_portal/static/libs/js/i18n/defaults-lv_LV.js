  ...
  (function ($) {
    $.fn.selectpicker.defaults = {
      ...
      maxOptionsText: function (numAll, numGroup) {
        return [
          numAll == 1
            ? "Sasniegts limits ({n} ieraksts maksimums)"
            : "Sasniegts limits ({n} ieraksti maksimums)",
          numGroup == 1
            ? "Sasniegts grupas limits ({n} ieraksts maksimums)"
            : "Sasniegts grupas limits ({n} ieraksti maksimums)",
        ];
      },
