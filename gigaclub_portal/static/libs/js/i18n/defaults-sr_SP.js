  ...
  (function ($) {
    $.fn.selectpicker.defaults = {
      ...
      maxOptionsText: function (numAll, numGroup) {
        return [
          numAll == 1
            ? "Limit je dostignut ({n} stvar maximalno)"
            : "Limit je dostignut ({n} stavke maksimalno)",
          numGroup == 1
            ? "Grupni limit je dostignut ({n} stvar maksimalno)"
            : "Grupni limit je dostignut ({n} stavke maksimalno)",
        ];
      },
