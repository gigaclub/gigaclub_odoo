  ...
  (function ($) {
    $.fn.selectpicker.defaults = {
      ...
      maxOptionsText: function (numAll, numGroup) {
        return [
          numAll == 1
            ? "Лимита е достигнат ({n} елемент максимум)"
            : "Лимита е достигнат ({n} елемента максимум)",
          numGroup == 1
            ? "Груповия лимит е достигнат ({n} елемент максимум)"
            : "Груповия лимит е достигнат ({n} елемента максимум)",
        ];
      },
