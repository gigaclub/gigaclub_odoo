      ...
      if (ignoreDisabled) {
        for (var i = 0, len = selectedOptions.length; i < len; i++) {
          ...
          if (
            !(
              opt.disabled ||
              (opt.parentNode.tagName === "OPTGROUP" && opt.parentNode.disabled)
            )
          ) {
            options.push(opt);
          }
    ...
    var generateOption = {
      ...
      a: function (text, classes, inline) {
        ...
        if (typeof classes !== "undefined" && classes !== "")
          a.classList.add.apply(a.classList, classes.split(" "));
    ...
    Selectpicker.prototype = {
      ...
      setPositionData: function () {
        ...
        for (var i = 0; i < this.selectpicker.current.data.length; i++) {
          ...
          li.position =
            (i === 0 ? 0 : this.selectpicker.current.data[i - 1].position) + li.height;
        }
      },
      ...
      buildData: function () {
        ...
        function addOption(option, config) {
          ...
          if (config.divider) {
            ...
            config.selected = Boolean(option.selected);
            config.disabled = config.disabled || Boolean(option.disabled);
      ...
      liHeight: function (refresh) {
        ...
        menuInnerInner.className =
          classNames.MENU + " inner " + (version.major === "4" ? classNames.SHOW : "");
        ...
        var liHeight = li.offsetHeight,
          ...
          menuPadding = {
            vert:
              ...
              toInteger(
                menuStyle ? menuStyle.borderBottomWidth : $menu.css("borderBottomWidth")
              ),
            horiz:
              ...
              toInteger(
                menuStyle ? menuStyle.borderLeftWidth : $menu.css("borderLeftWidth")
              ) +
              toInteger(
                menuStyle ? menuStyle.borderRightWidth : $menu.css("borderRightWidth")
              ),
          },
          menuExtras = {
            vert:
      ...
      setMenuSize: function (isAuto) {
        ...
        if (this.options.dropupAuto) {
          ...
          estimate =
            liHeight * this.selectpicker.current.elements.length + menuPadding.vert;
        ...
        if (this.options.size === "auto") {
          ...
          minHeight =
            _minHeight + headerHeight + searchHeight + actionsHeight + doneButtonHeight;
          ...
          maxHeight =
            menuHeight + headerHeight + searchHeight + actionsHeight + doneButtonHeight;
        ...
        if (
          ...
          this.selectpicker.current.data[this.selectpicker.current.data.length - 1]
      ...
      keydown: function (e) {
        ...
        if (isArrowKey) {
          ...
          index = liActive
            ? Array.prototype.indexOf.call(liActive.parentElement.children, liActive)
            : -1;
