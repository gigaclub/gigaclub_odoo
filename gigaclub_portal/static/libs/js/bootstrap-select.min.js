...
!(function (e, t) {
  ...
  !(function (z) {
          ...
          var t = "classList",
            ...
            o = function () {
              ...
              return {
                add: function (e) {
                  return (
                    (e = Array.prototype.slice.call(arguments).join(" ")), i.addClass(e)
                  );
                },
                remove: function (e) {
                  return (
    ...
    function O(e, t) {
      ...
      if (t) {
        for (var o = 0, r = s.length; o < r; o++)
          (i = s[o]).disabled ||
            (i.parentNode.tagName === "OPTGROUP" && i.parentNode.disabled) ||
            n.push(i);
        return n;
      }
      return s;
    ...
    z.valHooks.select.set = function (e, t) {
      return (
        t && !p.useDefault && z(e).data("selected", !0), p._set.apply(this, arguments)
      );
    };
    var A = null,
      u = (function () {
    ...
    var I,
      ...
      S =
        ...
        ($ = RegExp(x, "g")),
        function (e) {
          return (e = e == null ? "" : String(e)), y.test(e) ? e.replace($, E) : e;
        });
    function E(e) {
      return I[e];
    }
    ...
    _.a.setAttribute("role", "option"),
      R.major === "4" && (_.a.className = "dropdown-item"),
    ...
    var G = new RegExp(B + "|" + M),
      ...
      K = {
        ...
        text: function (e, t) {
          ...
          if (!0 === t)
            for (; n.childNodes.length > 0; ) _.fragment.appendChild(n.childNodes[0]);
      ...
      var s = this.each(function () {
        ...
        if (e.is("select")) {
          ...
          if (t) {
            ...
            var n = e.data();
            for (var o in n)
              n.hasOwnProperty(o) && z.inArray(o, d) !== -1 && delete n[o];
    ...
    (Y.VERSION = "1.13.14"),
      ...
      (Y.prototype = {
        ...
        createView: function (A, e, t) {
          ...
          if (
            ...
            if (t) i = this.$menuInner[0].scrollTop;
              ...
              if (typeof n === "number" && !1 !== D.options.size) {
            ...
            if (
              ...
              for (var y = x.length; f < y; f++) {
                ...
                D.options.sanitize &&
                  ($ = E.lastChild) &&
                  (S =
                    D.selectpicker.current.data[f + D.selectpicker.view.position0]) &&
                  S.content &&
                  !S.sanitized &&
              ...
              if (
                ...
                !0 === u
                  ? ((v =
                      D.selectpicker.view.position0 === 0
                        ? 0
                        : D.selectpicker.current.data[D.selectpicker.view.position0 - 1]
                            .position),
                    (g =
                      D.selectpicker.view.position1 > d - 1
                        ? 0
                        : D.selectpicker.current.data[d - 1].position -
                          D.selectpicker.current.data[D.selectpicker.view.position1 - 1]
                            .position),
            ...
            if (((D.prevActiveIndex = D.activeIndex), D.options.liveSearch)) {
              if (A && t) {
                ...
                D.selectpicker.view.canHighlight[T] ||
                  (T = 1 + D.selectpicker.view.canHighlight.slice(1).indexOf(!0)),
        ...
        buildData: function () {
          ...
          function v(e, t) {
            if (
              (((t = t || {}).divider = e.getAttribute("data-divider") === "true"),
              t.divider)
            )
              m({optID: t.optID});
            else {
              ...
              t.optID && (o = "opt " + o),
                ...
                (t.index = i),
                (t.option = e),
                (t.selected = Boolean(e.selected)),
                (t.disabled = t.disabled || Boolean(e.disabled)),
                u.push(t);
            }
          }
          function i(e, t) {
        ...
        buildList: function () {
          ...
          function t(e) {
            ...
            n.push(t),
              ...
              e.icon && (i += 1),
              o < i && ((o = i), (s.selectpicker.view.widestOption = n[n.length - 1]));
          }
        ...
        render: function () {
          var e,
            t = this,
            i = this.$element[0],
            s = this.setPlaceholder() && i.selectedIndex === 0,
          ...
          if (
            ...
            this.tabIndex(),
            this.options.selectedTextFormat === "static")
          )
            ...
            (this.multiple &&
              ...
              o > 1 &&
              (((e = this.options.selectedTextFormat.split(">")).length > 1 &&
                o > e[1]) ||
                (e.length === 1 && o >= 2)))
          ) {
            if (!s) {
              for (var h = 0; h < o && h < 50; h++) {
                var p = n[h],
                  ...
                  f = {};
                this.multiple && h > 0 && c.appendChild(a.cloneNode(!1)),
                  p.title
                    ? (f.text = p.title)
                    : u &&
              ...
              o > 49 && c.appendChild(document.createTextNode("..."));
            }
          } else {
            var m =
          ...
          this.$element.attr("class") &&
            ...
            R.major < 4 &&
              ...
              n.parentNode.classList.contains("input-group") &&
                ...
                (n.previousElementSibling || n.nextElementSibling).classList.contains(
                  "input-group-addon"
                ) &&
        ...
        liHeight: function (e) {
          if (e || (!1 !== this.options.size && !Object.keys(this.sizeInfo).length)) {
            var t = document.createElement("div"),
              ...
              d =
                this.options.header && this.$menu.find("." + V.POPOVERHEADER).length > 0
            ...
            if (
              ...
              (n.className = V.MENU + " inner " + (R.major === "4" ? V.SHOW : "")),
            ...
            var v,
              ...
              y = z(o).outerHeight(!0),
              $ = Boolean(window.getComputedStyle) && window.getComputedStyle(i),
              S = i.offsetWidth,
              E = $ ? null : z(i),
              C = {
                vert:
        ...
        setMenuSize: function (e) {
          ...
          if (
            ...
            for (var b = 0; b < this.options.size; b++)
              this.selectpicker.current.data[b].type === "divider" && g++;
        ...
        selectPosition: function () {
          ...
          function e(e) {
            var t = {},
              i =
                r.options.display ||
                (Boolean(z.fn.dropdown.Constructor.Default) &&
          ...
          this.$button.on("click.bs.dropdown.data-api", function () {
            ...
            z(window)
              .off(
                "resize" + j + "." + this.selectId + " scroll" + j + "." + this.selectId
              )
              .on(
                "resize" +
                  j +
        ...
        setDisabled: function (e, t) {
          ...
          (this.selectpicker.main.data[e].disabled = t),
            ...
            i &&
              (R.major === "4" && i.classList.toggle(V.DISABLED, t),
              t
                ? (i.setAttribute("aria-disabled", t), i.setAttribute("tabindex", -1))
                : (i.removeAttribute("aria-disabled"), i.setAttribute("tabindex", 0)));
        },
        isDisabled: function () {
        ...
        clickListener: function () {
          ...
          function i() {
            C.dropdown && C.dropdown._popper && C.dropdown._popper.state.isCreated
              ? e()
          ...
          t.data("spaceSelect", !1),
            ...
            this.$element.on("shown" + j, function () {
              C.$menuInner[0].scrollTop !== C.selectpicker.view.scrollTop &&
                (C.$menuInner[0].scrollTop = C.selectpicker.view.scrollTop),
                R.major > 3 ? requestAnimationFrame(i) : e();
            }),
            ...
            this.$menuInner.on("click", "li a", function (e, t) {
              var i = z(this),
                ...
                d = !0;
              if (
                (C.multiple && C.options.maxOptions !== 1 && e.stopPropagation(),
                e.preventDefault(),
                ...
                if (
                  (r === C.activeIndex && (t = !0),
                  t || ((C.prevActiveIndex = C.activeIndex), (C.activeIndex = void 0)),
                  C.multiple)
                ) {
                  if (
                    ((h.selected = !u),
                    ...
                    if ((v && b) || (g && w))
                      if (v && v == 1)
                        ...
                        var k =
                            typeof C.options.maxOptionsText === "string"
                              ? [C.options.maxOptionsText, C.options.maxOptionsText]
                              : C.options.maxOptionsText,
                          y = typeof k === "function" ? k(v, g) : k,
                          $ = y[0].replace("{n}", v),
                          S = y[1].replace("{n}", g),
                          E = z('<div class="notify"></div>');
                        y[2] &&
                          (($ = $.replace("{var}", y[2][v > 1 ? 0 : 1])),
                          (S = S.replace("{var}", y[2][g > 1 ? 0 : 1]))),
                          (h.selected = !1),
                          C.$menu.append(E),
                          v &&
                            b &&
                ...
                !C.multiple || (C.multiple && C.options.maxOptions === 1)
              ...
              if (
                ...
                for (var l = 0; l < u.selectpicker.main.data.length; l++) {
                  ...
                  s[l] || (s[l] = k(a, i, o, r)),
                    s[l] &&
                      ...
                      (s[a.lastIndex + 1] = !0)),
                    s[l] && a.type !== "optgroup-label" && n.push(l);
                }
                l = 0;
                for (var c = n.length; l < c; l++) {
                  var d = n[l],
                    h = n[l - 1],
                    p =
                      ((a = u.selectpicker.main.data[d]), u.selectpicker.main.data[h]);
                  (a.type !== "divider" ||
                    (a.type === "divider" &&
                      p &&
                      p.type !== "divider" &&
        ...
        val: function (e) {
          ...
          if (
            ...
            if (this.multiple) this.setOptionStatus(!0);
              ...
              typeof s === "number" &&
                (this.setSelected(this.selectedIndex, !1), this.setSelected(s, !0));
            }
              ...
              if (
                    ...
                    ? (t !== -1 && t--,
                      ...
                      a.selectpicker.view.canHighlight[t + f] ||
                        ((t =
                          ...
                          (t = c.length - 1)))
                    : (e.which !== M && !h) ||
                      (++t + f >= a.selectpicker.view.canHighlight.length && (t = 0),
                      a.selectpicker.view.canHighlight[t + f] ||
                        (t =
                          t +
                          1 +
                ...
                e.which === B
                  ? f === 0 && t === c.length - 1
                    ...
                    : (d =
                        (o = (n = a.selectpicker.current.data[m]).position - n.height) <
                        u)
                  : (e.which !== M && !h) ||
                    (t === 0
                ...
                if (b.length) {
                  ...
                  c.removeClass("active").find("a").removeClass("active"),
                    g.length === 1 &&
                      ((x = b.indexOf(a.activeIndex)) === -1 || x === b.length - 1
                        ? (x = 0)
                        : x++),
                    (v = b[x]),
                    (d =
                      u - (n = a.selectpicker.main.data[v]).position > 0
