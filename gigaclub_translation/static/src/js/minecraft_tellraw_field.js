/** @odoo-module alias=gigaclub_translation.minecraft_tellraw_field **/
"use strict";

import minecraftTellrawFieldModule from "minecraft_field_tellraw.minecraft_tellraw_field";
...
class MinecraftTellrawField extends minecraftTellrawField {
  ...
  _prepareParams() {
    ...
    if (params) {
      this.state.params = `Parameters: ${params.map((p) => "${" + p + "}").join(", ")}`;
    }
  }
}
